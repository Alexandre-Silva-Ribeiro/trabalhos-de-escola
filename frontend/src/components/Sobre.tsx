const aboutParagraphs: ReadonlyArray<string> = [
  ...
  "Cheguei a jogar basquete também, mas parei quando meu círculo social mudou (e de novo, graças a mim). As pessoas com quem jogava se afastaram, e sozinho o jogo perdeu a graça. Esporte depende de outras pessoas, então sozinho não faz muito sentido. Não foi dramático, a vontade só sumiu de forma repentina.",
